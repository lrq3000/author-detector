...
## @package basepreprocessor
#
# This contains the base pre processor class that you can use as a template for other classes

from authordetector.base import BaseClass

## BasePreProcessor
#
# Base pre processor class that you can use as a template for other classes
# Simply return the same as the input
class BasePreProcessor(BaseClass):
    ...
    ## Do various preprocessing stuff
