...
#
# This contains the base detector class that you can use as a template for other classes

from authordetector.base import BaseClass

## BaseDetector
#
# Base detector class that you can use as a template for other classes
...
class BaseDetector(BaseClass):
    ...
    # @param L_Patterns The extracted patterns from the learning corpus of texts
    # @param Patterns The extracted patterns from the text(s) to detect
