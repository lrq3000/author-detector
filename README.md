...
Finally, the sharing of compiled machine learning models, ie, what are nowadays called the "weights", as a way to share a closed source form of a machine learning program, is nowadays very prevalent, especially with huggingface.co. This was imagined in oacs to avoid the requirement of sharing the source data, which would have been problematic for cheat systems makers, who would have been able to easily access this data and derive rules to circumvent them, in addition to legal issues about private data sharing of the system's (game) legitimate users. This is one of the major reasons why AI has seen a boom in development in the 2020s.
